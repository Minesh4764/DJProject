			...
			React.createElement("div", {className: "slider"}, 
				React.createElement("div", {id: "flex1", className: "flexslider"}, 
					React.createElement("ul", {className: "slides"}, 
						...
						React.createElement("li", null, React.createElement("div", {className: "picture"}, " ", React.createElement("img", {src: "img/slider/slider1.jpg", alt: ""}))), 

						React.createElement("li", null, React.createElement("div", {className: "picture"}, React.createElement("img", {src: "img/slider/slider2.jpg", alt: ""}))), 

						React.createElement("li", null, React.createElement("div", {className: "picture"}, React.createElement("img", {src: "img/slider/slider3.jpg", alt: ""})))
...
React.createElement("div", {id: "about", className: "color yellow"}, 
		
	React.createElement("div", {id: "page-title"}, 

				React.createElement("div", {id: "page-title-inner"}, 

						React.createElement("h2", null, React.createElement("span", null, "About Us"))
      	...
      	React.createElement("div", {className: "row-fluid"}, 
				...
				React.createElement("div", {className: "span12"}, 
					...
					React.createElement("div", {id: "story"}, 
					...
					React.createElement("div", {id: "history"}, 
						...
						React.createElement("p", null, 
							React.createElement("span", {className: "dropcap"}, "P"), "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi."
						), 
						React.createElement("p", null, 
							React.createElement("span", {className: "dropcap color"}, "P"), "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi."
						), 
						React.createElement("p", null, 
							React.createElement("span", {className: "dropcap dark"}, "P"), "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi."
						), 
						React.createElement("p", null, 
							"Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi."
						)
			...
			React.createElement("div", {className: "row-fluid"}, 		
				...
				React.createElement("div", {className: "span12"}, 
			       	...
			       	React.createElement("ul", {className: "progress-bar"}, 
						React.createElement("li", null, 
			            	React.createElement("h5", null, "Web Design ( 40Percent )")
			          	), 
			        	React.createElement("li", null, 
			            	React.createElement("div", {className: "meter"}, React.createElement("span", {className: "forty"}))
			          	), 
						React.createElement("li", null, 
			            	React.createElement("h5", null, "Wordpress ( 80Percent )")
			          	), 
			          	React.createElement("li", null, 
			            	React.createElement("div", {className: "meter"}, React.createElement("span", {className: "sixty"}))
			          	), 
						React.createElement("li", null, 
			            	React.createElement("h5", null, "Branding ( 100Percent)")
			          	), 
			          	React.createElement("li", null, 
			            	React.createElement("div", {className: "meter"}, React.createElement("span", {className: "eighty"}))
			          	), 
			          	React.createElement("li", null, 
			            	React.createElement("h5", null, "SEO Optmization ( 60%)")
			          	), 
						React.createElement("li", null, 
			            	React.createElement("div", {className: "meter"}, React.createElement("span", {className: "oneHundred"}))
			          	)
			      	)
...
var Eve = React.createClass({displayName: "Eve",
  render : function() {

   return ( 
 React.createElement("h1", null, 
   React.createElement("div", {className: "jumbotron"}, 
         "DJJB Past Events today"
     )
)
   	);
...
React.createElement("div", {id: "services", className: "color black"}, 
		...
		React.createElement("div", {className: "container"}, 
			...
			React.createElement("div", {className: "clearfix"}), 
			     React.createElement("hr", {className: "clean"}, " ")				
			)
...
var Team = React.createClass({displayName: "Team",
  render : function() {
   ...
   return ( 
React.createElement("div", {id: "team", className: "color white"}, 
...
React.createElement("div", {id: "page-title"}, 
	...
	React.createElement("div", {id: "page-title-inner"}, 
			...
			React.createElement("h2", null, React.createElement("span", null, "Team"))
			...
			React.createElement("div", {className: "row-fluid"}, 
				...
				React.createElement("div", {className: "span3"}, 
					React.createElement("div", {className: "avatar"}, 
						React.createElement("img", {className: "img-circle", src: "img/team_member.jpg", alt: "team member"})
					), 	
					React.createElement("div", {className: "team-name"}, "Minesh Patel"), 
					React.createElement("div", {className: "position"}, "Co-Founder, CEO"), 
					React.createElement("p", null, 
						"Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat." 
					), 
					React.createElement("div", {className: "social_profiles"}, 
						React.createElement("ul", {className: "social-bookmarks"}, 
							React.createElement("li", {className: "facebook"}, React.createElement("a", {href: ""}, "facebook")), 
							React.createElement("li", {className: "flickr"}, React.createElement("a", {href: ""}, "flickr")), 
							React.createElement("li", {className: "linkedin"}, React.createElement("a", {href: "#"}, "linkedin")), 
							React.createElement("li", {className: "twitter"}, React.createElement("a", {href: "#"}, "twitter"))
						)
					)	
				), 
			
				
				React.createElement("hr", {className: "clean visible-phone"}), 
...
React.render(React.createElement(Pricing, null),document.getElementById('Price'));
React.render(React.createElement(PortFolios, null),document.getElementById('PortFolio'));
React.render(React.createElement(Abouts, null),document.getElementById('AboutusDiv'));
React.render(React.createElement(Team, null),document.getElementById('Team'));
React.render(React.createElement(Contact, null),document.getElementById('DjContact'));

},{"./components/PortFolio":158,"./components/Price":159,"./components/bout":160,"./components/events":161,"./components/homepage":162,"./components/out":163,"./components/team":164,"jquery":2,"react":157}]},{},[165]);
